...
public final class Sensor {
     ...
     * Air Quality Station
     * 
     * @brief Identificadores (IDs) dos sensores customizadas na camada da HAL
     * <p>Ponto de entrada para sensores customizados da Estação de Qualidade do Ar.</p>
     * 
     * <p>Estes sensores utilizam o intervalo de tipos privados (Custom) do Android 
     * (acima de {@link #TYPE_DEVICE_PRIVATE_BASE}).</p>
     *
     * @see #TYPE_DEVICE_PRIVATE_BASE
     */

    /**
     * @brief Sensor de Material Particulado 2.5 (PM2.5).
     * <p>Mede a concentração de partículas finas com diâmetro inferior a 2,5 micrômetros.</p>
     * <b>Unidade:</b> Microgramas por metro cúbico (ug/m3)
     */
    public static final int TYPE_PM25 = 0x10001; // 65537
    public static final String STRING_TYPE_PM25 = "com.airstation.sensor.pm25";

    /**
     * @brief Sensor de Material Particulado 10 (PM10).
     * <p>Mede a concentração de partículas com diâmetro inferior a 10 micrômetros.</p>
     * <b>Unidade:</b> Microgramas por metro cúbico (ug/m3)
     */
    public static final int TYPE_PM10 = 0x10002; // 65538
    public static final String STRING_TYPE_PM10 = "com.airstation.sensor.pm10";

    /**
     * @brief Sensor de Monóxido de Carbono (CO).
     * <p>Mede a concentração de gás monóxido de carbono no ambiente.</p>
     * <b>Unidade:</b> Partes por milhão (ppm)
     */
    public static final int TYPE_CO = 0x10003; // 65539
    public static final String STRING_TYPE_CO = "com.airstation.sensor.co";

    /**
     * @brief Sensor de Gases Inflamáveis / LPG.
     * <p>Detecta a presença de gases combustíveis, como GLP, propano e butano.</p>
     * <b>Unidade:</b> Partes por milhão (ppm)
     */
    public static final int TYPE_LPG = 0x10004; // 65540
    public static final String STRING_TYPE_LPG = "com.airstation.sensor.lpg";

    /**
     * @brief Sensor de Metadados: Fonte de Dados da Qualidade do Ar.
     * <p>Indica a origem dos dados recebidos pelo HAL.</p>
     * <b>Valores:</b> 0 = Conexão Serial/USB, 1 = Conexão Remota/Wi-Fi.
     */
    public static final int TYPE_AIR_QUALITY_SOURCE = 0x10005; // 65541
    public static final String STRING_TYPE_AIR_QUALITY_SOURCE = "com.airstation.sensor.air_quality_source";

    // --- Fim da declaraçãos dos identificadores dos sensores da Air Quality Station
