...
// ==========================================
void loop() {
  // Leitura da Serial (Não bloqueante)
  // O Arduino agora é passivo: só responde quando perguntado.
...
void processCommand(String cmd) {
  ...
  // --- COMANDOS GET DATA (Requisição única) ---
...
void sendSensorData(String target) {
  ...
  // target ja foi convertido para minusculo se não for ALL
...
void sendSettings() {
  ...
  // Intervalo removido pois não há mais stream contínuo
...
void sendMetadata() {
  ...
  s4["id"] = "co_ppm"; s4["name"] = "Monoxido Carbono"; s4["unit"] = "ppm";
