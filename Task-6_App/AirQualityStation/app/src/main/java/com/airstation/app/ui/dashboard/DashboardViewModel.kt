...
class DashboardViewModel @Inject constructor(
    ...
    // 2. Controle do Histórico (Qual sensor o usuário quer ver no gráfico?)
    ...
    // 3. O Fluxo de Histórico (Reage automaticamente à mudança do sensor acima)
    ...
    val historyState: StateFlow<List<AirQualityReading>> = _selectedHistorySensor
        ...
        .stateIn(
            ...
            started = SharingStarted.WhileSubscribed(5000), // Pausa se sair da tela
    ...
    // Função para a UI chamar quando clicar na aba do sensor
